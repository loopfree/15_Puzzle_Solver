  ...
  <div class="horizontal" style="justify-content: center">
    ...
    <div class="horizontal" v-if="hasResult">
      <div class="vertical result-div">
        ...
        <div>
          <p>
            &Sigma; <sub>i=0</sub> <sup>16</sup> KURANG(i) + X = {{ kurangX }}
          </p>
        </div>
      </div>
...
@-webkit-keyframes glow {
  from {
    text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #122b7d,
      0 0 40px #122b7d, 0 0 50px #122b7d, 0 0 60px #122b7d, 0 0 70px #122b7d;
  }
...
@-webkit-keyframes breathing-glow {
  ...
  to {
    text-shadow: 0 0 20px #fff, 0 0 30px #6b2db2, 0 0 40px #6b2db2,
      0 0 50px #6b2db2, 0 0 60px #6b2db2, 0 0 70px #6b2db2, 0 0 80px #6b2db2;
  }
}
